...
# ----------------------------------
# Class FileHandler for Amino Acids.
# ----------------------------------
...
class FileHandler(AbsFileHandler):
    ...
    ISOELECTRIC_POINT: Final = 'isoelectric_point'
    SMILES: Final = 'smiles'
    CODONS: Final = 'codons'

    def __init__(self):
        super().__init__('amino_acids.csv')
    ...
    def get_isoelectric_point(self, id):
        return self._find_value(id, self.ISOELECTRIC_POINT)

    def get_smiles(self, id):
        return self._find_value(id, self.SMILES)

    def get_codons(self, id):
        return self._find_value(id, self.CODONS)
